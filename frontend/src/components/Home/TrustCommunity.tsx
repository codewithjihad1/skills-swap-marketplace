      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <motion.p 
            ...
            viewport={{ once: true }}
          >
            Join a global community of learners backed by top tech companies, featured in leading publications, 
        ...
        >
          <motion.div className="text-center mb-8" variants={itemVariants}>
            ...
            <p className="text-gray-600 dark:text-gray-400">
              Official training partners and certification providers
            </p>
          </motion.div>
        ...
        >
          ...
          >
            {[
              { icon: "M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z", label: "SSL Encrypted", color: "green" },
              { icon: "M12 15v2m-6 4h12a2 2 0 002-2v-6a2 2 0 00-2-2H6a2 2 0 00-2 2v6a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z", label: "GDPR Compliant", color: "blue" },
              { icon: "M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z", label: "SOC 2 Certified", color: "purple" },
              { icon: "M13 10V3L4 14h7v7l9-11h-7z", label: "99.9% Uptime", color: "orange" }
            ].map((badge, index) => (
              <motion.div
                key={badge.label}
              ...
              >
                <svg className={`w-5 h-5 text-${badge.color}-600`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d={badge.icon} />
                </svg>
                <span className={`text-sm font-medium text-${badge.color}-700 dark:text-${badge.color}-300`}>
                  {badge.label}
                </span>
              </motion.div>
            ))}
