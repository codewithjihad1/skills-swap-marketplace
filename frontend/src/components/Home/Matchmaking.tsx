...
const matchSteps: MatchStep[] = [
  ...
  },
  {
    ...
    description: 'Our AI finds perfect skill-swap partners based on compatibility',
    icon: '🤖',
  ...
  },
  {
    id: 3,
    title: 'Connect & Chat',
    description: 'Review profiles and start conversations with potential partners',
    icon: '💬',
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          >
            ...
            Trade skills, share knowledge, and grow together in our vibrant community.
          </motion.p>
            ...
            {matchSteps.map((step, index) => (
              <motion.div
                ...
                className={`relative text-center p-6 rounded-2xl bg-white dark:bg-gray-800 shadow-lg border border-gray-200 dark:border-gray-700 ${
                  currentStep === index ? 'ring-2 ring-primary ring-opacity-50' : ''
                }`}
              >
                {/* Step Number */}
                ...
                <motion.div 
                  ...
                  transition={{ duration: 0.6, repeat: currentStep === index ? Infinity : 0, repeatDelay: 2 }}
                >
                  {step.icon}
                </motion.div>
                ...
                >
                  <div className={`h-full bg-gradient-to-r ${step.color} rounded-full`} />
                </motion.div>
              </motion.div>
            ))}
          </div>
            ...
            >
              <div className="flex items-center space-x-4 mb-6">
                ...
                <div>
                  ...
                  <p className="text-gray-600 dark:text-gray-400">{sampleUsers[0].location}</p>
            ...
            <div className="space-y-4">
                      ...
                      <div className="flex items-center space-x-1">
                        ...
                        <div className="flex">
                          {[...Array(5)].map((_, i) => (
                            <motion.div
                              key={i}
                              className={`w-2 h-2 rounded-full ${i < 4 ? 'bg-green-500' : 'bg-gray-300 dark:bg-gray-600'}`}
                              initial={{ scale: 0 }}
                              animate={{ scale: 1 }}
                        ...
                        <span className="text-xs text-green-600 dark:text-green-400 font-medium">95%</span>
                      </div>
                      
                      <span className={`text-xs px-2 py-1 rounded-full ${
                        user.level === 'Advanced' ? 'bg-red-100 text-red-700 dark:bg-red-900/30 dark:text-red-300' :
                        user.level === 'Intermediate' ? 'bg-yellow-100 text-yellow-700 dark:bg-yellow-900/30 dark:text-yellow-300' :
              ...
              {matches.length === 0 && !isMatching && (
                ...
                >
                  ...
                  <p>Click "Start Matching Demo" to see potential matches!</p>
                </motion.div>
              )}
            </div>
          </motion.div>
            ...
            >
              ...
              >
                ...
                <p className="text-gray-600 dark:text-gray-400 mb-4">
                  Your skill swap request has been sent to {selectedUser.name}. 
