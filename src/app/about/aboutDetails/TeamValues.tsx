  ...
  const values = [
    {
      ...
      description: "We believe everyone has something to teach and something to learn. Knowledge grows when shared.",
      icon: Users,
    ...
    },
    {
      ...
      description: "Our platform thrives on genuine connections. We prioritize people over profits in every decision.",
      icon: HeartHandshake,
    ...
    },
    {
      ...
      description: "We're committed to creating the highest quality skill-sharing experiences for our community.",
      icon: Award,
    ...
    {
      title: "Global Impact",
      description: "We're building a borderless platform where skills transcend geographical limitations.",
      icon: Globe,
    ...
    },
    {
      ...
      description: "We embrace evolution, constantly improving our platform based on community feedback.",
      icon: TrendingUp,
    ...
    {
      title: "Trust & Safety",
      description: "We maintain a secure environment where members feel comfortable sharing and learning.",
      icon: Shield,
  ...
  return (
    <section className="py-24 px-4 md:px-8 lg:px-16 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          <motion.div variants={fadeIn} className="inline-flex items-center justify-center mb-6 px-6 py-3 bg-background/10 backdrop-blur-md rounded-full border border-foreground/10 shadow-sm">
            <Sparkles className="w-5 h-5 text-secondary-2 mr-2" />
            <span className="text-sm font-semibold text-secondary-2 uppercase tracking-wider">Our Core Values</span>
          </motion.div>
          
          <motion.h2 variants={fadeIn} className="text-4xl md:text-5xl lg:text-6xl font-bold mb-6">
            The Principles That <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-primary-3">Guide Us</span>
          </motion.h2>
          
          <motion.p variants={fadeIn} className="text-xl text-foreground/80 max-w-3xl mx-auto leading-relaxed">
            At SkillShareHub, our values are the foundation of everything we do. They shape our platform, 
            our community, and our vision for the future of skill sharing.
          </motion.p>
        </motion.div>
            ...
            return (
              ...
              >
                ...
                <div className="relative h-full bg-background border border-foreground/10 rounded-2xl p-8 shadow-sm hover:shadow-lg transition-all duration-500 overflow-hidden">
                  ...
                  <div className={`absolute inset-0 bg-gradient-to-br ${value.color}/5 opacity-0 group-hover:opacity-100 transition-opacity duration-500`}></div>
                  ...
                  >
                    <div className={`w-12 h-12 bg-gradient-to-br ${value.color} rounded-lg flex items-center justify-center`}>
                      <IconComponent className="w-6 h-6 text-white" />
                    </div>
                  </motion.div>
                  
                  {/* Content */}
                  <h3 className="text-xl font-semibold mb-4 relative z-10">{value.title}</h3>
                  <p className="text-foreground/70 relative z-10">{value.description}</p>
        ...
        >
          <div className="bg-gradient-to-r from-primary/10 to-secondary/10 rounded-2xl p-12 border border-foreground/10 relative overflow-hidden">
            ...
            <div className="relative z-10">
              <h3 className="text-2xl md:text-3xl font-bold mb-6">Share Your Skills With The World</h3>
              <p className="text-lg text-foreground/80 max-w-2xl mx-auto mb-8">
                Join a community that values knowledge sharing, growth, and meaningful connections.
              </p>
